...
const Layout = () => {
  ...
  return (
    <div id="innerContent" className={isChangeTheme == true? "darkTheme" : "lightTheme"}>
      <div id="navigation" className={isChangeTheme == true ? "float-start darkTheme": "float-start lightTheme"}>
        <div id="menu">
                    ...
                    <ul className="navbar-nav">
                      ...
                      
                      {
                        ...
                        <li className={active.activeAccount == true || activeItem == 3 ? "active" : ""}>
                          <div className={isChangeTheme == true? "menuList darkTheme" : "menuList lightTheme"}>
                          <Link className="nav-link pe-2" to={`/employees/${id}`} onClick={() => { setActive({ activeAccount: true, activeDashboard: false, activeEmployees: false }); saveActiveItem(3); }}><FontAwesomeIcon icon={faUser} className='me-2' />My Account</Link>
                          </div>
                        </li>
                      }
                    </ul>
